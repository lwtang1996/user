...
from .utils import \
    ...
    VIRTUAL_MACHINE, VCENTER, VMUUID, VMMEMORY, VMCPU, VMNAME, VMIP, \
    VMNETMASK, VMDNS, \
    ...
    NETWORK_STATUS_DELETING, NETWORK_STATUS_STOPPED, NETWORK_STATUS_UPDATING,\
    NODETYPE_PEER, NODETYPE_ORDERER, NODETYPE_CA, NODETYPE_CLI, ELEMENT_PVC, \
    EXTERNAL_SUB_MAX, EXTERNAL_SUB_MIX, \
    CA_PORTS_UPPER_LIMIT, ORDERER_PORTS_UPPER_LIMIT
