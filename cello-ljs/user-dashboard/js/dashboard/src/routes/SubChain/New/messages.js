...
const messages = defineMessages({
  ...
  title: {
    id: "Path.SubChainNew",
    defaultMessage: "Apply New Sub Chain"
  },
  configuration: {
    basic: {
      title: {
  ...
  form: {
    ...
    label: {
      ...
      chainconfig: {
        id: "Chain.New.form.label.chainconfig",
        defaultMessage: "Chain config file"
      },
      chainaddress: {
        id: "Chain.New.form.label.chainaddress",
        defaultMessage: "Chain Adresses"
      },
      chainType: {
