...
const messages = defineMessages({
  ...
  form: {
    ...
    validate: {
      ...
      org: {
        required: {
          id: "ChainCode.form.validate.org.required",
          defaultMessage: "Must select peers"
        },
      },
      version: {
        required: {
          id: "ChainCode.form.validate.version.required",
          defaultMessage: "Must input chaincode version"
        },
      },
      chainType: {
        required: {
