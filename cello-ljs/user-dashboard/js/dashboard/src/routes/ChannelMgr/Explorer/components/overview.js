...
class Overview extends React.Component {
  ...
  render() {
    const {chain, intl,smartChainCodes} = this.props;
        ...
        <Row gutter={24}>
          ...
          < Col {...topColResponsiveProps}>
            <ChartCard
              ...
              total={smartChainCodes ? smartChainCodes.length || 0 : 0}
              contentHeight={46}
            />
          </Col>
          ...
          {/*{ chain.initialized &&*/}
            {/*<Col {...topColResponsiveProps}>*/}
              {/*<ChartCard*/}
                ...
                {/*action={<Tooltip title={intl.formatMessage(messages.help.transaction)}><Icon*/}
                  {/*type="info-circle-o"/></Tooltip>}*/}
