...
class NewsBlock extends React.Component {
  ...
  render() {
    const {chains, recentBlocks: { recentBlocks } , loadingRecentBlocks}= this.props.chain;
    const {chains:subchains, recentBlocks: { recentBlocks:subrecentBlocks } , loadingRecentBlocks:subloadingRecentBlocks}= this.props.subchain;
